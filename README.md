...
This system is a double-cross system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.
...
![image](http://mattsmith.in/images/double-cross.png)
